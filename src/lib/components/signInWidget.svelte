...
<Button class="space-x-1 group w-[100px]" variant="ghost" on:click={async () => {
    await signInWithGoogle()
}}>
    <p>Sign in<p/>
    <div class="invisible opacity-0 w-0 group-hover:visible group-hover:opacity-100 group-hover:w-full transition-all duration-300">
